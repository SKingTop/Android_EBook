...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            idTopic = savedInstanceState.getInt(ID_TOPIC, R.id.frame00);
        } else {
            ...
            idTopic = sPref.getInt(ID_TOPIC, R.id.frame00);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        // Блок выбора тем
        if (id == R.id.frame00) {
            webView.loadUrl(resourceDir + "FRAME00/frame00.htm");
        } else if (id == R.id.frame01) {
            webView.loadUrl(resourceDir + "FRAME01/frame01.htm");
        } else if (id == R.id.frame02) {
            webView.loadUrl(resourceDir + "FRAME02/frame02.htm");
        } else if (id == R.id.frame03) {
            webView.loadUrl(resourceDir + "FRAME03/frame03.htm");
        } else if (id == R.id.frame04) {
            webView.loadUrl(resourceDir + "FRAME04/frame04.htm");
        } else if (id == R.id.frame05) {
            webView.loadUrl(resourceDir + "FRAME05/frame05.htm");
        }
